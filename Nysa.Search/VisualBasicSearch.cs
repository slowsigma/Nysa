...
public static class VisualBasicSearch
{
    ...
    public static void FindAndDump(String baseDir, List<String> exclude_paths, String outFile, List<(String StartsWith, String ReplaceWith)> headerSwaps)
    {
        ...
        var extensions  = new HashSet<String>(new String[] { ".bas", ".cls" }, StringComparer.OrdinalIgnoreCase);
        ...
        Boolean exclude_line(String line)
            =>    line.Trim().Make(t =>    t.StartsWith("'")
                                        || t.StartsWith("[System.Xml.Serialization.XmlTypeAttribute")
