...
namespace Nysa.Text.Parsing
{
    ...
    internal struct BuildStates : IEquatable<BuildStates>
    {
        ...
        public Boolean Equals(BuildStates other)        => this._Value.Equals(other._Value);
        public override Int32 GetHashCode()             => this._Value.GetHashCode();
        public override Boolean Equals(Object other)    => (other is BuildStates) ? this.Equals((BuildStates)other) : false;
    }
