...
namespace Nysa.Text
{
    ...
    public struct TextSpan : IEquatable<TextSpan>
    {
        ...
        public String  Value    { get => this.Length > 0 ? Source?.Substring(this.Position, this.Length) : (this.Source == null ? null : String.Empty); }
        ...
        public override Boolean Equals(Object obj)
            => (obj is TextSpan) ? this.Equals((TextSpan)obj) : false;
