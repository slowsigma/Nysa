    ...
    public static partial class Take
    {
        ...
        public class AnyOneNode : Node
        {
            ...
            public override HitOrMiss Find(TextSpan current)
                => current.End
                          .Next()
                          .Map(n => this._Alternatives.Contains(this.IgnoreCase ? Char.ToUpperInvariant(n) : n) ? HitOrMiss.NewHit(current.Appended(1)) : HitOrMiss.NewMiss(1))
        ...
        //            return HitOrMiss.NewHit(largestHit.Value.Span, identifiedHit is Some<Hit> someIdHit ? someIdHit.Value.Id : Identifier.None);
        //        }
        //        else if (f.IsHit)
