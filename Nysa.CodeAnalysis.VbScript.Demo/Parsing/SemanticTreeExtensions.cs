...
namespace Nysa.CodeAnalysis.VbScript.Demo
{
    ...
    public static class SemanticTreeExtensions
    {
        ...
        public static ViewInfo ToViewInfo<T>(this T @this, Func<IEnumerable<ViewInfo>>? children = null, Boolean childrenHighlight = false)
            where T : CodeNode
        ...
        public static ViewInfo ToViewInfo(this Nysa.CodeAnalysis.VbScript.Semantics.Identifier @this)
        ...
        public static ViewInfo ToViewInfo(this ArgumentDefinition @this)
            => new ViewInfo(@this.Name.Value, @this, _NoMore, true);
        ...
        public static ViewInfo ToViewInfo(this FunctionDeclaration @this)
            => @this.ToViewInfo(Properties(@this.Visibility.Map(v => @this.ValueProperty(nameof(MethodDeclaration.Visibility), v.ToString())).OrNull(),
                                          ...
                                          new ViewInfo(nameof(MethodDeclaration.Arguments), @this, () => @this.Arguments.Select(a => a.ToViewInfo()), false),
        ...
        public static ViewInfo ToViewInfo(this Statement @this)
            => @this switch
            {
                ...
                OptionExplicitStatement optExplicitStmt => new ViewInfo(nameof(OptionExplicitStatement), optExplicitStmt, _NoMore, true),
        ...
        public static ViewInfo ToViewInfo(this Program @this)
            => @this.ToViewInfo(() => @this.Statements.Select(s => s.ToViewInfo()), false);
