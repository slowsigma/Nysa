...
namespace Nysa.WpfLx
{
    ...
    public class OkCancelDialog : DialogView
    {
        public static Boolean Show(String title, String message, NormalWindow owner)
        {
            ...
            var window = Visuals.NormalWindow()
                                .Affected(w =>
                                {
                                    ...
                                    var okCancelPanel = Visuals.DialogButtonPanel("OK".DialogButton(() => { result = false; w.Close(); }).Sized(60.0, 26.0),
                                                                                  "Cancel".DialogButton(() => { result = true; w.Close(); }).Sized(60.0, 26.0));
            ...
            var dialog = window.Bound(vw => new OkCancelDialog(vw, owner)).ViewModel;
        ...
        private OkCancelDialog(NormalWindow window, NormalWindow owner) : base(window, owner) { }
    }
