...
namespace Nysa.Data.PgSqlClient
{
    ...
    public class Read<TA>
    {
        ...
        public Func<NpgsqlDataReader, TResult> Make<TResult>(Func<TA, TResult> how) => r => how(A(r, 0));
    }
    ...
    public class Read<TA, TB>
    {
        ...
        public Func<NpgsqlDataReader, TResult> Make<TResult>(Func<TA, TB, TResult> how) => r => how(A(r, 0), B(r, 1));
    }
    ...
    public class Read<TA, TB, TC>
    {
        ...
        public Func<NpgsqlDataReader, TResult> Make<TResult>(Func<TA, TB, TC, TResult> how) => r => how(A(r, 0), B(r, 1), C(r, 2));
    }
    ...
    public class Read<TA, TB, TC, TD>
    {
        ...
        public Func<NpgsqlDataReader, TResult> Make<TResult>(Func<TA, TB, TC, TD, TResult> how) => r => how(A(r, 0), B(r, 1), C(r, 2), D(r, 3));
    }
    ...
    public class Read<TA, TB, TC, TD, TE>
    {
        ...
        public Func<NpgsqlDataReader, TResult> Make<TResult>(Func<TA, TB, TC, TD, TE, TResult> how) => r => how(A(r, 0), B(r, 1), C(r, 2), D(r, 3), E(r, 4));
    }
    ...
    public class Read<TA, TB, TC, TD, TE, TF>
    {
        ...
        public Func<NpgsqlDataReader, TResult> Make<TResult>(Func<TA, TB, TC, TD, TE, TF, TResult> how) => r => how(A(r, 0), B(r, 1), C(r, 2), D(r, 3), E(r, 4), F(r, 5));
    }
    ...
    public class Read<TA, TB, TC, TD, TE, TF, TG>
    {
        ...
        public Func<NpgsqlDataReader, TResult> Make<TResult>(Func<TA, TB, TC, TD, TE, TF, TG, TResult> how) => r => how(A(r, 0), B(r, 1), C(r, 2), D(r, 3), E(r, 4), F(r, 5), G(r, 6));
    }
    ...
    public class Read<TA, TB, TC, TD, TE, TF, TG, TH>
    {
        ...
        public Func<NpgsqlDataReader, TResult> Make<TResult>(Func<TA, TB, TC, TD, TE, TF, TG, TH, TResult> how) => r => how(A(r, 0), B(r, 1), C(r, 2), D(r, 3), E(r, 4), F(r, 5), G(r, 6), H(r, 7));
    }
    ...
    public class Read<TA, TB, TC, TD, TE, TF, TG, TH, TI>
    {
        ...
        public Func<NpgsqlDataReader, TResult> Make<TResult>(Func<TA, TB, TC, TD, TE, TF, TG, TH, TI, TResult> how) => r => how(A(r, 0), B(r, 1), C(r, 2), D(r, 3), E(r, 4), F(r, 5), G(r, 6), H(r, 7), I(r, 8));
    }
    ...
    public class Read<TA, TB, TC, TD, TE, TF, TG, TH, TI, TJ>
    {
        ...
        public Func<NpgsqlDataReader, TResult> Make<TResult>(Func<TA, TB, TC, TD, TE, TF, TG, TH, TI, TJ, TResult> how) => r => how(A(r, 0), B(r, 1), C(r, 2), D(r, 3), E(r, 4), F(r, 5), G(r, 6), H(r, 7), I(r, 8), J(r, 9));
    }
    ...
    public class Read<TA, TB, TC, TD, TE, TF, TG, TH, TI, TJ, TK>
    {
        ...
        public Func<NpgsqlDataReader, TResult> Make<TResult>(Func<TA, TB, TC, TD, TE, TF, TG, TH, TI, TJ, TK, TResult> how) => r => how(A(r, 0), B(r, 1), C(r, 2), D(r, 3), E(r, 4), F(r, 5), G(r, 6), H(r, 7), I(r, 8), J(r, 9), K(r, 10));
    }
    ...
    public class Read<TA, TB, TC, TD, TE, TF, TG, TH, TI, TJ, TK, TL>
    {
        ...
        public Func<NpgsqlDataReader, TResult> Make<TResult>(Func<TA, TB, TC, TD, TE, TF, TG, TH, TI, TJ, TK, TL, TResult> how) => r => how(A(r, 0), B(r, 1), C(r, 2), D(r, 3), E(r, 4), F(r, 5), G(r, 6), H(r, 7), I(r, 8), J(r, 9), K(r, 10), L(r, 11));
    }
    ...
    public class Read<TA, TB, TC, TD, TE, TF, TG, TH, TI, TJ, TK, TL, TM>
    {
        ...
        public Func<NpgsqlDataReader, TResult> Make<TResult>(Func<TA, TB, TC, TD, TE, TF, TG, TH, TI, TJ, TK, TL, TM, TResult> how) => r => how(A(r, 0), B(r, 1), C(r, 2), D(r, 3), E(r, 4), F(r, 5), G(r, 6), H(r, 7), I(r, 8), J(r, 9), K(r, 10), L(r, 11), M(r, 12));
    }
    ...
    public class Read<TA, TB, TC, TD, TE, TF, TG, TH, TI, TJ, TK, TL, TM, TN>
    {
        ...
        public Func<NpgsqlDataReader, TResult> Make<TResult>(Func<TA, TB, TC, TD, TE, TF, TG, TH, TI, TJ, TK, TL, TM, TN, TResult> how) => r => how(A(r, 0), B(r, 1), C(r, 2), D(r, 3), E(r, 4), F(r, 5), G(r, 6), H(r, 7), I(r, 8), J(r, 9), K(r, 10), L(r, 11), M(r, 12), N(r, 13));
    }
    ...
    public class Read<TA, TB, TC, TD, TE, TF, TG, TH, TI, TJ, TK, TL, TM, TN, TO>
    {
        ...
        public Func<NpgsqlDataReader, TResult> Make<TResult>(Func<TA, TB, TC, TD, TE, TF, TG, TH, TI, TJ, TK, TL, TM, TN, TO, TResult> how) => r => how(A(r, 0), B(r, 1), C(r, 2), D(r, 3), E(r, 4), F(r, 5), G(r, 6), H(r, 7), I(r, 8), J(r, 9), K(r, 10), L(r, 11), M(r, 12), N(r, 13), O(r, 14));
    }
